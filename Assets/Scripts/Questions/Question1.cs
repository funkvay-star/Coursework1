...
public class Question1 : MonoBehaviour
{
	...
	[SerializeField] List<string> _question = new List<string> { "Кто был отцом Давида?" };
	[SerializeField] List<string> _answers = new List<string> { "Санасар", "Младший Мгер", "Дядя Торос", "Старший Мгер" };
